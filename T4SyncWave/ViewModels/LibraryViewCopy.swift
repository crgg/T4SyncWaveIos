...
//            }
//            
//            self.joinSend = JoinSend(type: "join", room: groupModel.id.uuidString, userId: current_user.id, UserName: current_user.name, role: current_user.role ?? "member" )
